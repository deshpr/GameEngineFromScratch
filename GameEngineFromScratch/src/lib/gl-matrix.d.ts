...
interface vec3 {
  ...
  create(): Float32Array;
    ...
    /*
    * Include this definition to work with the .ts file.
    * 
    * @returns {vec3} a new 3D Vector pointing to the specified coordinate.
    */
   ...
   * @returns {vec3} out
   */
  rotateZ(out: Float32Array, a: Float32Array, c: number, b: Float32Array): Float32Array;
